...
def load_imagenet(
    ...
    if mask_type in ["narrow", "wide"]:
        ...
        mask_dir = os.path.join(
            os.getcwd(), f"datasets/mask/{mask_type}")
...
def load_image(
    offset=0, max_len=100, shape=(256, 256), mask_type="half", dataset_path=""
):
    gt_dir = os.path.join(os.getcwd(), f"./datasets/{dataset_path}/")
    gt_paths = _list_image_files_recursively(gt_dir)
    gt_paths.sort()
